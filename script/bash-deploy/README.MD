...
```bash
git clone https://github.com/superform-xyz/stx-contracts
git fetch --all
...
## Submit an issue.
Feel free to [submit an issue](https://github.com/superform-xyz/stx-contracts/issues/new/choose) if you can't find the solution here or you have any suggestions for the script.
